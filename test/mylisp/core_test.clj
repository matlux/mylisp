...
(deftest test-eval
  (testing "Special forms should work as expected"
    ...
    (testing ">> List manipulation forms (cons, first, rest) should be supported"
      (is (= [nil [1 2 3 4]] (core/eval-expr nil '[cons 1 [quote [2 3 4]]])))
      (is (= [nil 1] (core/eval-expr nil '[first [quote [1 2 3 4]]])))
      (is (= [nil [2 3 4]] (core/eval-expr nil '[rest [quote [1 2 3 4]]])))
      (is (= [nil nil] (core/eval-expr nil '[first 42])))
      (is (= [nil nil] (core/eval-expr nil '[first nil])))
      (is (= [nil 1] (core/eval-expr nil '[first [cons 1 nil]])))
      (is (= [nil 1] (core/eval-expr nil '[first[cons 1 [quote [2 3 4]]]])))
      (is (= [nil nil] (core/eval-expr nil '[rest 42])))
      (is (= [nil nil] (core/eval-expr nil '[rest nil])))
      (is (= [nil nil] (core/eval-expr nil '[rest [cons 1 nil]])))
      (is (= [nil [2 3 4]] (core/eval-expr nil '[rest [cons 1 [quote [2 3 4]]]]))))
